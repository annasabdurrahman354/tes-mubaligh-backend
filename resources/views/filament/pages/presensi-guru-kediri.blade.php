        ...
        @if($attendanceData != [] && $distinctTanggalSesi != [])
            <x-filament::section wire:loading.remove>
                ...
                <div id="view-print" class="overflow-auto mt-4">
                    <table style="table-layout: auto; border-collapse: collapse; border: 1px solid #CBD5E1; font-size: 0.875rem; line-height: 1.25rem;" cellpadding="5">
                        <thead>
                        <tr>
                            <th style="border: 1px solid #CBD5E1; text-align: left;" colspan="{{ array_sum(array_map('count', $distinctTanggalSesi)) + 8 }}">
                        ...
                        <tr>
                            ...
                            @endforeach
                            <th style="border: 1px solid #CBD5E1; text-align: center;" colspan="2">Jumlah</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;" rowspan="2">Total<br>Pertemuan</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;" rowspan="2">Total<br>Simak</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;" colspan="2">Persen</th>
                        </tr>
                        <tr>
                            @foreach($distinctTanggalSesi as $date => $sessions)
                                ...
                                @endforeach
                            @endforeach
                            <th style="border: 1px solid #CBD5E1; text-align: center;">H</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;">A</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;">H</th>
                            <th style="border: 1px solid #CBD5E1; text-align: center;">A</th>
                        </tr>
                        </thead>
                            ...
                            <tr>
                                ...
                                @foreach($distinctTanggalSesi as $date => $sessions)
                                    @foreach($sessions as $session)
                                        ...
                                        @endphp
                                        @if($val)
                                            <td style="border: 1px solid #CBD5E1; text-align: center; background-color: rgb(34 197 94);">
                                                {{ $val }}
                                            </td>
                                        @elseif($val === 0)
                                ...
                                <td style="border: 1px solid #CBD5E1; text-align: right;">{{ $guru['jumlah']['alpa'] }}</td>
                                ...
                                <td style="border: 1px solid #CBD5E1; text-align: right;">{{ $guru['persen']['hadir'] }}</td>
                                <td style="border: 1px solid #CBD5E1; text-align: right;">{{ $guru['persen']['alpa'] }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
