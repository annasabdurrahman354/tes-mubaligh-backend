...
class KinerjaGuruKertosonoExporter extends Exporter
{
    ...
    public static function getCompletedNotificationBody(Export $export): string
    {
        ...
        $body = 'Data hasil kinerja guru Kertosono periode '.$periode['monthName'].' '.$periode['year'].' sejumlah ' . number_format($export->successful_rows) . ' ' . str('baris')->plural($export->successful_rows) . ' berhasil diekspor.';
